...
const metrics = computed(() => data.value ? [
  ...
  { label: '已确认收入', value: `$${data.value.metrics.revenue.value.toFixed(2)}`, metric: data.value.metrics.revenue, icon: CircleDollarSign, color: 'orange', to: '/admin/metrics/revenue' },
