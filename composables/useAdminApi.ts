...
export const useAdminApi = () => {
  ...
  return {
    ...
    verifyOrder: (orderNo: string) => request<{ paypalStatus: string; captureStatus: string | null; refundStatus: string | null; synchronized: boolean; refundReconciliationRequired: boolean; refundAmount: string | null; message: string | null }>(`/admin/orders/${orderNo}/verify`, { method: 'POST' }),
