...
- 上传要求：MP4、H.264 8 位视频、AAC-LC 音频、faststart；单文件不超过 20 GB。提供离线 2 秒 HLS 切片工具；分片就绪后自动使用多清晰度播放，未切片视频采用流式 MP4。部署与旧视频处理见 [`docs/R2-MP4-DELIVERY.md`](./docs/R2-MP4-DELIVERY.md)。
